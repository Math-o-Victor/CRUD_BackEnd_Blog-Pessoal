...
public class UsuarioControllerTest {
	...
	public void deveAtualizarUmUsuario() {
		...
		UsuarioModel UsuarioModelUpdate = new UsuarioModel(usuarioCreate.get().getId(), 
			"Juliana Andrews Ramos", "juliana_ramos@email.com.br", 
			"juliana123", "https://i.imgur.com/yDRVeK7.jpg");
		
		HttpEntity<UsuarioModel> requisicao = new HttpEntity<UsuarioModel>(UsuarioModelUpdate);
		...
		assertEquals(UsuarioModelUpdate.getNome(), resposta.getBody().getNome());
		assertEquals(UsuarioModelUpdate.getUsuario(), resposta.getBody().getUsuario());
	}
